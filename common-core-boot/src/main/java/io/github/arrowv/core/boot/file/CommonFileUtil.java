...
import io.github.arrowv.core.tool.utils.StringPool;
import io.github.arrowv.core.tool.utils.StringUtil;
...
public class CommonFileUtil {
	 ...
	 * @return BladeFile
	 */
	public static CommonFile getFile(MultipartFile file) {
	 ...
	 * @return BladeFile
	 */
	public static CommonFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static CommonFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new CommonFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return BladeFile
	 */
	public static List<CommonFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BladeFile
	 */
	public static List<CommonFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static List<CommonFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<CommonFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new CommonFile(file, dir, path, virtualPath));
		}
		return list;
	}
