...
import io.github.arrowv.core.tool.utils.ImageUtil;
 ...
 * @author Chill
 */
public class CommonFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{CommonFileUtil.formatUrl(uploadPath.toString()), CommonFileUtil.formatUrl(virtualPath.toString())};
	}
